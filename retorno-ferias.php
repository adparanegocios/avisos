...
WHERE
    ...
    CONVERT(DATETIME,CONVERT(VARCHAR,DATEADD(DAY,1,P.DATAFIM),103),103) = CONVERT(DATETIME,CONVERT(VARCHAR,GETDATE(),103),103)
...
$assunto = utf8_decode("[TOTVS] RETORNO de Férias HOJE - Data: $data_incio");
$count = 0;
...
<html>
	...
	<body>
        ...
        <strong>ESCALA DE F&Eacute;RIAS</strong>
        </div>
