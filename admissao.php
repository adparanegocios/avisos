...
SELECT 
    ...
    CONVERT(VARCHAR(10),F.DATAADMISSAO,103) AS [ADMISSAO],
...
INNER JOIN PFHSTSIT H (NOLOCK) ON (H.CHAPA = F.CHAPA AND H.CODCOLIGADA = F.CODCOLIGADA AND H.MOTIVO = '01' AND H.NOVASITUACAO = 'A')
WHERE
...
$assunto = utf8_decode("[TOTVS] Admissões - Data: $data_incio");
$count = 0;
...
<html>
	...
	<body>
		<div style='text-align: center;'>
			<strong>ADMISS&Atilde;O - DATA: $data_incio</strong></div>
			...
			<table align='center' border='1' cellpadding='1' cellspacing='1'>
				...
				<thead>
					<tr>
						...
						<th scope='col'><font color='#ff0000'>ADMISS&Atilde;O</font></th>
...
while($row = $rs->fetch(PDO::FETCH_OBJ)){
    ...
    <tr>
		...
		<td>$secao</td>
		<td>$funcao</td>
		<td><span style='color:#ff0000;'>$admissao</span></td>
		<td>$cadastro</td>
	</tr>
    ";
    $count++;
...
foreach($vetEmails["admissao"] as $email){
