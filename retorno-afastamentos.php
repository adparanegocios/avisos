...
WHERE
    ...
    CONVERT(DATETIME,CONVERT(VARCHAR,A.DTFINAL,103),103) = CONVERT(DATETIME,CONVERT(VARCHAR,GETDATE(),103),103)
...
$assunto = utf8_decode("[TOTVS] RETORNO de Afastamentos (Licença Maternidade, Previdência, Acidente de Trabalho, ...) HOJE - Data: $data_incio");
$count = 0;
...
<html>
	...
	<body>
		...
		<strong>AFASTAMENTOS <em>(LICEN&Ccedil;A MATERNIDADE, PREVID&Ecirc;NCIA, ACIDENTE DE TRABALHO, ...)</em></strong></div>
