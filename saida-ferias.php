...
WHERE
    ...
    CONVERT(DATETIME,CONVERT(VARCHAR,P.DATAINICIO,103),103) = CONVERT(DATETIME,CONVERT(VARCHAR,GETDATE(),103),103)
...
$assunto = utf8_decode("[TOTVS] SAÍDA de Férias HOJE - Data: $data_incio");
$count = 0;
